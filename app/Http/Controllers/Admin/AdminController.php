...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $appointments = DB::table('appointment')
                        ...
                        ->select('users.name as agent_name', 'customers.cust_name as customer_name','customers.cust_address as cust_address', 'customers.telecallername', 'type_of_appointment.appointment_name', 'appointment.appointment_date', 'time_slots.time_slot', 
                          'appointment.status','appointment.comments')
