    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Sanctioned Customer Data</h5>
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('back-office.customers.editsanctioned', $customer->cust_id) }}"  class="dropdown-item"><i class="icon-pencil"></i> Edit </a>
