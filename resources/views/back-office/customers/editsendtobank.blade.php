                    ...
                    <form action="{{ route('back-office.customers.updatesendtobank', $customer->id) }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control"  name="property_cost" id="property_cost" required="required" 
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="applied_loan_amount" name="applied_loan_amount"  
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="file_number" name="file_number" required value="{{ old('file_number') ?? $customer->file_no }}">
                                @error('file_number')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
