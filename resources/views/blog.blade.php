                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                           ...
                           <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="post-block mb30">
                                <div class="post-img">
                                    <a href="blog-single.html" class="imghover"><img src="images/blog-img-3.jpg" alt="Borrow - Loan Company Website Template" class="img-fluid"></a>
                                </div>
                                <div class="bg-white pinside40 outline">
                                    <h2><a href="blog-single.html" class="title">Bigger home still the goal</a></h2>
                                    <p class="meta"><span class="meta-date">Aug 20, 2017</span><span class="meta-author">By<a href="#"> Admin</a></span></p>
                           ...
                           <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="post-block mb30">
                                <div class="post-img">
                                    <a href="blog-single.html" class="imghover"><img src="images/blog-img-4.jpg" alt="Borrow - Loan Company Website Template" class="img-fluid"></a>
                                </div>
                                <div class="bg-white pinside40 outline">
                                    <h2><a href="blog-single.html" class="title">5 Essential Financial Habits</a></h2>
                                    <p class="meta"><span class="meta-date">Aug 15, 2017</span><span class="meta-author">By<a href="#"> Admin</a></span></p>
                         ...
                         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="post-block mb30">
                                <div class="post-img">
                                    <a href="blog-single.html" class="imghover"><img src="images/blog-img-5.jpg" alt="Borrow - Loan Company Website Template" class="img-fluid"></a>
                                </div>
                                <div class="bg-white pinside40 outline">
                                    <h2><a href="blog-single.html" class="title">How to Get a Scholarship</a></h2>
                                    <p class="meta"><span class="meta-date">Aug 12, 2017</span><span class="meta-author">By<a href="#"> Admin</a></span></p>
